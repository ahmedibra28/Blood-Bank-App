...
<div className="input-group">
              ...
              <select name="blood_group" onChange={handleChange} value={values.blood_group} className="form-control py-2">
...
<div className="input-group">
              ...
              <select name="blood_component" onChange={handleChange} value={values.blood_component} className="form-control py-2">
                <option value="" disabled>Blood Component...</option>
