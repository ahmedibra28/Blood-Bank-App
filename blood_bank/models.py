...
class BloodRequest(models.Model):
    ...
    blood_group = models.CharField(max_length=5)
    plasma = models.CharField(max_length=5, blank=True, null=True)
    platelet = models.CharField(max_length=5, blank=True, null=True)
    rbc = models.CharField(max_length=5, blank=True, null=True)
    whole_blood = models.CharField(max_length=5, blank=True, null=True)
